...
<div class="ars-donations-embed-wrapper">
	<div id="archivebox-page-nav" class="donate-box">
		<div class="banking-details single-banking-details fl">
			<div id="donate-left" class="donate-left-box">
				<form id="contactForm" action="https://www.paypal.com/cgi-bin/webscr" method="post">
					...
					<div align="left" style="float: left;margin-top:12px;padding-right: 8px;"><a
							href="https://www.paypal.com/" target="_blank"><img width="55" height="15"
																				src="<?php echo bloginfo( 'template_url' );
																				_e( '/images/paypal_logo.gif', 'arsofia' ); ?>"></a>
					</div>
        ...
        <input type="hidden" name="cmd" value="_donations">
					...
					<span id="ppGo" style="display:none;"> <img
							src="<?php bloginfo( 'template_url' ); ?>/images/pay-loader.gif" align="absmiddle"/>
						...
						<td class="ep1 epay-view-name">
							<div style="float: left;margin-top: 10px;padding-right: 8px;">
								<a href="https://www.epay.bg/" target="_blank">
									<img width="55" height="15"  src="https://arsofia.com/wp-content/uploads/2013/09/epay-logo.png">
								</a>
							</div>
							<input class="fl" style="font-size:18px;text-align: right;" name="TOTAL" value="20" size="4"
								   type="text"/>
							&nbsp;&nbsp;Лева
						</td>
					</tr>
					...
					<tr>
						<td class="ep3 epay-view-name" colspan="2">
							<input style="margin-top: 6px;"
								   class="epay-button paypal-button"
								   name="BUTTON:EPAYNOW" type="submit"
								   value="ДАРИ С EPAY"/>
						</td>
					</tr>
					<tr></tr>
	...
	<div class="fl fib-1">
		<div class="fl" style="margin-top: 4px;">
			<a href="https://www.fibank.bg/" target="_blank">
				<img width="110" height="30" alt="FIBank logo"
					 src="<?php echo bloginfo( 'template_url' ) . '/images/fbanklogo.png' ?>">
			</a>
		</div>
		...
		<div class="dms-embed-mobile">
			<div class="dms-mobile-inner">
				...
				<p class="dms-embed-number">SMS <span class="dms-color">DMS DOG</span> НА <span
						class="dms-color">17 777</span></p>
				<small class="donation-embed-info">1 лев дарение за абонати на vivacom, telenor и m-tel (няма
					ДДС)</small>
			</div>
		</div>
	</div>
